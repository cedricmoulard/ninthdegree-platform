...
export const exceptionThrown = createAction(
  ExceptionsEventTypes.ExceptionThrown,
  props<{ exception: ThrowableException }>()
);

export const exceptionsCleared = createAction(
  ExceptionsEventTypes.ExceptionsCleared
);

export type ExceptionsEventsUnion = ReturnType<typeof exceptionThrown |
